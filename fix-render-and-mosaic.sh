...
const featured = allProjects
  ...
  .slice(0, 4);
const projects = featured.length >= 2 ? featured : allProjects
  .sort((a, b) => b.data.year - a.data.year)
  .slice(0, 4);
...
// Fallback placeholder colors for each card slot
const colors = ['#C8C2B2','#B0AA9C','#989082','#7E786C'];
---
...
<Layout title="Architecture & Construction Excellence">
  ...
  <!-- PROJECTS — Balanced mosaic B, 4 cards -->
  <section class="projects">
    ...
    <div class="mosaic">
      ...
      <div class="mosaic-row mosaic-row--top">
        ...
        <!-- If fewer than 2 projects, fill with placeholder cards -->
        {projects.length < 1 && (
          <article class="mosaic-card mosaic-card--placeholder">
            <a href="/admin" class="mosaic-link">
              <div class="mosaic-img">
                <div class="mosaic-ph" style={`background:${colors[0]};`}></div>
                <div class="mosaic-overlay">
                  <div class="mosaic-overlay-inner">
                    <span class="mosaic-cat">Add in CMS</span>
                    <h2 class="mosaic-title">Your First Project</h2>
                  </div>
                </div>
              </div>
            </a>
        ...
        {projects.length < 2 && projects.length >= 1 && (
          <article class="mosaic-card mosaic-card--placeholder">
            <a href="/admin" class="mosaic-link">
              <div class="mosaic-img">
                <div class="mosaic-ph" style={`background:${colors[1]};`}></div>
                <div class="mosaic-overlay">
                  <div class="mosaic-overlay-inner">
                    <span class="mosaic-cat">Add in CMS</span>
                    <h2 class="mosaic-title">Add Second Project</h2>
                  </div>
                </div>
              </div>
            </a>
      ...
      <!-- Row 2: portrait left + wide landscape right -->
      <div class="mosaic-row mosaic-row--bot">
        {projects.length >= 3 ? (
          <article class="mosaic-card mosaic-card--portrait" data-anim="rise" data-delay="3">
            <a href={`/projects/${projects[2].id}`} class="mosaic-link">
              <div class="mosaic-img">
                {projects[2].data.cover && !projects[2].data.cover.includes('placeholder')
                  ? <img src={projects[2].data.cover} alt={projects[2].data.title} loading="lazy" />
                  : <div class="mosaic-ph" style={`background:${colors[2]};`}></div>
                }
                <div class="mosaic-overlay">
                  <div class="mosaic-overlay-inner">
                    <span class="mosaic-cat"
                      data-en={projects[2].data.category}
                      data-th={projects[2].data.category_th || projects[2].data.category}>
                      {projects[2].data.category}
                    </span>
                    <h2 class="mosaic-title"
                      data-en={projects[2].data.title}
                      data-th={projects[2].data.title_th || projects[2].data.title}>
                      {projects[2].data.title}
                    </h2>
                    <span class="mosaic-year">{projects[2].data.year}</span>
                  </div>
                  <span class="mosaic-arrow">→</span>
                </div>
              </div>
          ...
          <article class="mosaic-card mosaic-card--portrait mosaic-card--placeholder">
            <a href="/admin" class="mosaic-link">
              <div class="mosaic-img">
                <div class="mosaic-ph" style={`background:${colors[2]};`}></div>
                <div class="mosaic-overlay">
                  <div class="mosaic-overlay-inner">
                    <span class="mosaic-cat">Add in CMS</span>
                    <h2 class="mosaic-title">Third Project</h2>
                  </div>
                </div>
              </div>
            </a>
        ...
        {projects.length >= 4 ? (
          <article class="mosaic-card mosaic-card--wide" data-anim="rise" data-delay="4">
            <a href={`/projects/${projects[3].id}`} class="mosaic-link">
              <div class="mosaic-img">
                {projects[3].data.cover && !projects[3].data.cover.includes('placeholder')
                  ? <img src={projects[3].data.cover} alt={projects[3].data.title} loading="lazy" />
                  : <div class="mosaic-ph" style={`background:${colors[3]};`}></div>
                }
                <div class="mosaic-overlay">
                  <div class="mosaic-overlay-inner">
                    <span class="mosaic-cat"
                      data-en={projects[3].data.category}
                      data-th={projects[3].data.category_th || projects[3].data.category}>
                      {projects[3].data.category}
                    </span>
                    <h2 class="mosaic-title"
                      data-en={projects[3].data.title}
                      data-th={projects[3].data.title_th || projects[3].data.title}>
                      {projects[3].data.title}
                    </h2>
                    <span class="mosaic-year">{projects[3].data.year}</span>
                  </div>
                  <span class="mosaic-arrow">→</span>
                </div>
              </div>
          ...
          <article class="mosaic-card mosaic-card--wide mosaic-card--placeholder">
            <a href="/admin" class="mosaic-link">
              <div class="mosaic-img">
                <div class="mosaic-ph" style={`background:${colors[3]};`}></div>
                <div class="mosaic-overlay">
                  <div class="mosaic-overlay-inner">
                    <span class="mosaic-cat">Add in CMS</span>
                    <h2 class="mosaic-title">Fourth Project</h2>
                  </div>
                </div>
              </div>
            </a>
  ...
  <section class="about">
    <div class="about-inner">
      <div class="about-text">
        ...
        <a href="/about" class="link-underline" data-anim="rise" data-delay="3"
  ...
  <section class="contact">
    ...
    <a href="/contact" class="contact-btn" data-anim="rise" data-delay="3"
      data-en="Start a Conversation" data-th="เริ่มบทสนทนา">Start a Conversation</a>
  </section>
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .mosaic-link:hover .mosaic-ph,
  .mosaic-link:hover .mosaic-img img { transform:scale(1.06); }
  ...
  .mosaic-card--placeholder .mosaic-cat { color:rgba(247,244,239,0.4); }
  .mosaic-card--placeholder .mosaic-overlay { opacity:0.6; }
...
<script>
  ...
  document.querySelectorAll('[data-anim="line"]').forEach((el:any) => {
    el.style.transform='scaleX(0)'; el.style.transformOrigin='left';
